...
class _AllalumnipageState extends State<Allalumnipage> {
  ...
  final Future<List<Map<String, dynamic>>> _alumniFuture=
      Supabase.instance.client.from('Alumni Datas').select();
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context,  snapshot) {
          ...
          return ListView.builder(
            ...
            final alumniSeries = alumni['Series']?.toString() ?? 'N/A'; // .toString() ব্যবহার করা নিরাপদ
